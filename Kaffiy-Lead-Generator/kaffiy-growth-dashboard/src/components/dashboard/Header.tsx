import { Coffee, Moon, Sun, Bell, RefreshCw, RotateCcw, Sparkles } from 'lucide-react';
...
export function Header({ stats, onRefresh, onReset, onOpenAILearning }: HeaderProps) {
      ...
      <div className="container mx-auto px-3 sm:px-4 lg:px-6">
        <div className="flex h-14 items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-1.5 shrink-0">
            ...
            {onOpenAILearning && (
              <Button variant="ghost" size="icon" className="h-8 w-8" onClick={onOpenAILearning} title="AI Learning Center">
