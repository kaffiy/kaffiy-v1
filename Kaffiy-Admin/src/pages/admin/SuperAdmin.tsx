...
export default function SuperAdmin() {
    ...
    // Helper to verify slug uniqueness or format could be added here
        ...
        <DashboardLayout>
            <div className="space-y-6">
                <div className="flex items-center justify-between">
                    <div>
                        <h2 className="text-3xl font-bold tracking-tight">Süper Admin Paneli</h2>
                        <p className="text-muted-foreground">Sistemdeki tüm kafeleri buradan yönetebilirsiniz.</p>
                    </div>
