...
export default function Contact() {
  ...
  return (
    <Layout>
      {/* Hero */}
      <section 
        className="section-padding relative overflow-hidden transition-colors duration-500"
        style={{
          background: '#F8FAFC',
        }}
      >
        ...
        <div className="section-container relative z-10">
          <div className="max-w-2xl mx-auto text-center">
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-heading font-bold mb-4 sm:mb-6 tracking-tight text-slate-800" style={{ letterSpacing: '-0.02em' }}>
              {t("contact.title")}
            </h1>
            <p className="text-base sm:text-lg md:text-xl leading-relaxed mb-8 sm:mb-10 text-slate-600">
              {t("contact.subtitle")}
            </p>

            <div 
              className="rounded-2xl border p-5 sm:p-6 md:p-8 lg:p-10 shadow-lg text-center transition-all duration-500 backdrop-blur-sm"
              style={{
            ...
            >
              ...
              <h2 className="font-heading font-bold text-xl mb-3 text-slate-800">
                {t("contact.cardTitle")}
              </h2>
            ...
            <p className="text-sm mt-8 leading-relaxed text-slate-500">
              {t("contact.note")}
            </p>
          </div>
        </div>
